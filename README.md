...
## Result :
The digital input was successfully interfaced with the ARM microcontroller, and the input signal was detected correctly. The IoT operation was executed successfully and the expected output was obtained.
